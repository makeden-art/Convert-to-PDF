...
import matplotlib
import sys
sys.path.append('/opt/road-pdf-platform/backend')
...
# draw only 1000 entities to be fast
entities = doc.modelspace()
frontend.draw_entities(entities)

fig.savefig('/opt/road-pdf-platform/shared/documents/test_ezdxf_black.pdf', format='pdf', bbox_inches='tight', facecolor='white')
print("Done!")
