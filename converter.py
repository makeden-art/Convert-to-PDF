    ...
    *,
    ...
    if merge:
        ...
        if paths:
            ...
            inputs = resolve_ordered_inputs(paths, recursive=recursive, excluded_paths=excluded_paths)
...
def resolve_ordered_inputs_with_format(
    ...
    *,
    ...
    files = resolve_ordered_inputs(paths, recursive=recursive, excluded_paths=excluded_paths)
